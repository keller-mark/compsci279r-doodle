...
export const t1_jan2 = [
  ...
  {
    // Friday, two hours
    start: new Date("January 6, 2023 8:00:00"),
    end: new Date("January 6, 2023 10:00:00"),
    states: {
      'Elena': STATE.NO,
      'Mark': STATE.MAYBE,
      'Priyan': STATE.YES,
...
export const t1_jan9 = [
  {
    // Monday, four hours
    start: new Date("January 9, 2023 02:00:00"),
    end: new Date("January 9, 2023 06:00:00"),
    states: {
      // Store the selection of each participant for this time slot.
      'Elena': STATE.YES,
      'Mark': STATE.NO,
  ...
  {
    // Thursday, five hours
    start: new Date("January 12, 2023 13:00:00"),
  ...
  {
    // Friday, two hours
    start: new Date("January 13, 2023 18:00:00"),
    end: new Date("January 13, 2023 20:00:00"),
    states: {
      'Elena': STATE.NO,
      'Mark': STATE.MAYBE,
      'Priyan': STATE.YES,
...
export const t2_nextweek = [
  ...
  {
    start: new Date(nextMondayMs + msPerDay + msPerHour * 20),
    end: new Date(nextMondayMs + msPerDay + msPerHour * 21),
    states: {
      'Elena': STATE.MAYBE,
      'Mark': STATE.NO,
      'Priyan': STATE.NO,
